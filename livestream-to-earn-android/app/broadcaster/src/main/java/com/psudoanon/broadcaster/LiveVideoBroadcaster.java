...
import com.psudoanon.broadcaster.encoder.CameraSurfaceRenderer;
import com.psudoanon.broadcaster.encoder.TextureMovieEncoder;
import com.psudoanon.broadcaster.encoder.VideoEncoderCore;
import com.psudoanon.broadcaster.network.IMediaMuxer;
import com.psudoanon.broadcaster.network.RTMPStreamer;
import com.psudoanon.broadcaster.utils.Resolution;
import com.psudoanon.broadcaster.utils.Utils;
...
public class LiveVideoBroadcaster extends Service implements ILiveVideoBroadcaster, CameraHandler.ICameraViewer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public boolean startBroadcasting(String rtmpUrl) {
        ...
        try {
            ...
            if (result) {
                ...
                audioHandler.startAudioEncoder(mRtmpStreamer, SAMPLE_AUDIO_RATE_IN_HZ, minBufferSize, mAudioBitrate);
    ...
    public void setIFrameIntervalSeconds(int seconds) {
        sVideoEncoder.setIframeInterval(seconds);
    }
