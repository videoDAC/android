...
public class VideoEncoderCore {
     ...
     */
    public VideoEncoderCore(int width, int height, int bitRate, int frameRate, int iframeInteral, IMediaMuxer writerHandler)
            throws IOException {
       ...
       // this.frameRate = frameRate;
        ...
        format.setInteger(MediaFormat.KEY_I_FRAME_INTERVAL, iframeInteral);
